...
/src contains the source files for the website, /build contains the processed files for the website and are meant to be deployed to the production site, this index.html in this directory is where Google PSI should be tested.
